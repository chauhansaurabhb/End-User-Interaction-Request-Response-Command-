...
public class AndroidBadgeReader implements IBadgeReader, BadgeReaderKeys,
		ISensorListener {
	...
	/*
	 * @Override public BadgeStruct getbadgeDisappeared(){ //TODO: Device
	...
	/*
	 * @Override public BadgeStruct getbadgeDetected(){ //TODO: Device Developer
	 * write here device logic. //Sample code for reference.
	 * //if(TemperatureSensorData != null) { // return new
	 * TempStruct(Double.parseDouble
	 * (TemperatureSensorData.get(DISTANCE).toString()), "C"); // }else{ // if
	 * data is null, then return a Default value // return new TempStruct(-5 ,
